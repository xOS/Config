...
[task-local]
# > 奈非解锁检测
event-interaction https://hub.nange.cn/Script/Others/NFCheck.js, tag=奈非检测, img-url=text.magnifyingglass.system, enabled=true

**/

const BASE_URL = 'https://www.netflix.com/title/'
const FILM_ID = 81215567
const link = { "media-url": "https://hub.nange.cn/QuantumultX/iColor/Netflix.png" }
